...
while number_of_images < MAX_NUMBER_OF_IMAGES:
	...
	display = cv2.copyMakeBorder(frame, 0, 50, 0, 0, cv2.BORDER_CONSTANT, value= (0, 0, 0))
	...
	#cv2.putText(display, "Count: " + str(number_of_images), (10, display.shape[0] - 25), cv2.FONT_HERSHEY_PLAIN, 2.5, (255, 255, 255), 2)
